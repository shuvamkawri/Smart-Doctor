...
import 'package:ai_medi_doctor/presentation/forgot/password_change_form.dart';
...
class _OTPVerificationPageState extends State<OTPVerificationPage> {
  ...
  Future<void> verifyOTP() async {
    ...
    try {
      final response = await post('user/verify-otp-for-forgot-password',
      ...
      if (responseData['success']) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PasswordChangeForm(mobile: widget.mobile),
          ),
        );
      } else {
        setState(() {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // SizedBox(height: 25),
                // Row(
                //   mainAxisAlignment:MainAxisAlignment.start, // Center the row horizontally
                //   children: [
                //     Text(
                //       "Didn't receive it? ",
                //       style: TextStyle(

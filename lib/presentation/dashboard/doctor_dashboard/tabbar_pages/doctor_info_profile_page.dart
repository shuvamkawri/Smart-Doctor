...
class _DoctorInfoProfilePageState extends State<DoctorInfoProfilePage> with SingleTickerProviderStateMixin {
  ...
  double profileCompletion = 25.0; // Variable to track profile completion


  // Function to update profile completion based on user actions
  void _updateProfileCompletion() {
    // Assuming the profile completion is based on four steps
    setState(() {
      profileCompletion = (currentStep + 1) * 25;
    });
  }
  ...
  Future<void> DoctorInfoData(TabController tabController) async {
    ...
    final requestData = {
      ...
      "status_percentage": profileCompletion,
    ...
    if (data['errorCode'] == 200) {
      ...
      setState(() async {
        ...
        selectedTreatment = Treatment
            .firstWhere(
                (treatment) => treatment.name == fetchTreatmentType)
            .id;
  ...
  void openSuccessAlert(BuildContext context, String message) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(
            'Success', style: TextStyle(fontWeight: FontWeight.bold),),
  ...
  void showSuccessAlert(BuildContext context, TabController tabController) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: TabBar(
                                    ...
                                    controller:
                                    _tabController, // assign the controller
                                  ),
                                ),
                                SizedBox(
                                  height: 10,
                                                  ...
                                                  children: [
                                                    ...
                                                    Positioned(
                                                      ...
                                                      child: CircleAvatar(
                                                        radius:
                                                        20.0,
                                                        // Adjust radius as needed for the size of the edit button
                                                        backgroundColor:
                                                        Colors.white,
                                                        child: IconButton(
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  SizedBox(
                                                      height:
                                                      10.0),
                                                  // Use height instead of width for spacing
                                                  Text(
                                                    _image == null
                                                        ? ''
                                                        : _image!.path,
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  child: Card(
                                                    color: Colors
                                                        .yellowAccent,
                                                    // Set the card color to yellow accent
                                                    child: Padding(
                                                      padding: const EdgeInsets
                                                          .all(
                                                          8.0),
                                                      ...
                                                      child: ListTile(
                                                        ...
                                                        subtitle: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                                'Years: ${qualification
                                                                    .startYear} - ${qualification
                                                                    .endYear}'),
                                                            Text(
                                                                'Percentage: ${qualification
                                                                    .percentage}'),
                                                            Text(
                                                                'Total Marks: ${qualification
                                                                    .totalMarks}'),
                                                          ],
                                                        ),
                                                        trailing: Row(
                                                      ...
                                                      child: ListTile(
                                                        ...
                                                        subtitle: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                                'Period: ${affiliation
                                                                    .startAffiliationDate} - ${affiliation
                                                                    .endAffiliationDate}'),
                                                            Text(
                                                                        ...
                                                                        .map(
                                                                          ...
                                                                          return CheckboxListTile(
                                                                            ...
                                                                            onChanged:
                                                                              ...
                                                                              setState(
                                                                                      () {
                                                                                    final existingIndex = selectedSubCategories
                                                                                        .indexWhere((
                                                                                        sc) =>
                                                                                    sc
                                                                                        .name ==
                                                                                    ...
                                                                                    if (existingIndex !=
                                                                                        -1) {
                                                                                      selectedSubCategories[existingIndex]
                                                                                          .isSelected =
                                                                                          value ??
                                                                                              false;
                                                                                    } else {
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      ElevatedButton(
                                                                        onPressed:
                                                                          ...
                                                                          List<
                                                                              String> selectedNames = selectedSubCategories
                                                                              .where((
                                                                              sc) =>
                                                                          sc
                                                                              .isSelected)
        ...
        bottomNavigationBar: Container(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min, // Make the column fit its children
            children: [
              // Display profile completion percentage
              Padding(
                padding: const EdgeInsets.only(bottom: 8.0), // Add spacing
                child: Text(
              ...
              LinearProgressIndicator(
                value: profileCompletion / 100, // Update based on profileCompletion
              ...
              SizedBox(height: 16),
              // Add some space between progress bar and stepper
              SizedBox(
                ...
                child: Stepper(
                  ...
                  onStepTapped: (step) {
                    ...
                    _updateProfileCompletion(); // Update profile completion
                  },
                  onStepContinue: () {
                    if (currentStep < 3) {
                      setState(() {
  ...
  Future<void> _updateDashboardStatus() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    int profileCompletion = (currentStep + 1) *
        25; // Calculate completion percentage

    // Check if profile is 25% complete
    if (profileCompletion == 25) {
      await prefs.setBool('dashboardStatus', true); // Save dashboard status
    }
  }
}

// Function to update dashboard status in SharedPreferences
// Future<void> _updateDashboardStatus() async {
//   SharedPreferences prefs = await SharedPreferences.getInstance();
//   int profileCompletion = (currentStep + 1) * 25; // Calculate completion percentage
//
//   // Check if profile is 25% complete
//   if (profileCompletion == 25) {
//     await prefs.setBool('dashboardStatus', true); // Save dashboard status

...
//   }
//
//   Future<void> DoctorInfoData() async {
...
//
//     // Date format pattern (you can adjust it to your specific format, here we use 'MM/dd/yyyy')
...
//       "experience_details": experienceDetails.text,
//       "biography": biograpgy.text,
...
//
//   final TextEditingController _qualificationNameController =
...
//       if (responseJson['errorCode'] == 200) {
//         SharedPreferences prefs = await SharedPreferences.getInstance();
//         prefs.setString('qualification', body);
//         print('hospitalAffilation info Data saved locally $body');
//         showSuccessAlert(context, message);
//       } else if (responseJson['errorCode'] == 201) {
//         showErrorAlert(context, message);
//       }
...
//
//   final TextEditingController _hospitalAffiliationNameController =
//   TextEditingController();
//   final TextEditingController _cityAffiliationController =
//   TextEditingController();
//   final TextEditingController _countryAffiliationController =
//   TextEditingController();
//   final TextEditingController _startDateAffiliationController =
//   TextEditingController();
//   final TextEditingController _endDateAffiliationController =
//   TextEditingController();
//   final TextEditingController _totalExperienceAffiliationController =
//   TextEditingController();
//
...
//       if (responseJson['errorCode'] == 200) {
//         SharedPreferences prefs = await SharedPreferences.getInstance();
//         prefs.setString('hospitalAffilation', body);
//         print('hospitalAffilation info Data saved locally $body');
//         showSuccessAlert(context, message);
//       } else if (responseJson['errorCode'] == 201) {
//         showErrorAlert(context, message);
...
//
//   // List<TreatmentDoctorTab> DoctorTreatmentsSubCategory = [];
//
//   // Future<void> doctorTreatmentSubCategory(String category) async {
//   //   try {
...
//   //     final decodedResponse = json.decode(response);
//   //     print('Decoded response: $decodedResponse');
//   //     final List<dynamic> treatmentSubCategoryData = decodedResponse['results']['details'];
//   //     if (!mounted) return;
//   //     setState(() {
//   //       DoctorTreatmentsSubCategory = treatmentSubCategoryData.map((data) {return TreatmentDoctorTab.fromJson(data);}).toList();
//   //       print('TreatmentsSubCategory: $DoctorTreatmentsSubCategory');
//   //     });
//   //     print('Treatment loaded successfully: $DoctorTreatmentsSubCategory');
//   //   } catch (error) {
...
//                                                 border: Border.all(
//                                                   color: Colors
//                                                       .grey, // You can customize the border color and width
//                                                 ),
...
//                                                   SizedBox(
//                                                     width:
//                                                     10, // Adds some space between the button and the text
//                                                   ),
//                                                   Expanded(
//                                                     child: Text(
//                                                       _image == null
//                                                           ? 'No selected image'
//                                                           : _image!
//                                                           .path, // Optional: To handle long paths gracefully
//                                                       overflow:
...
//                                     //                           child: ListTile(
//                                     //                             title: Text(Treatment[index].name),
//                                     //                             trailing: Icon(Icons.arrow_forward_ios_rounded),
//                                     //                             onTap: () {
//                                     //                               setState(() {
//                                     //                                 selectedTreatmentCategory = Treatment[index].name.toString();
//                                     //                                 doctorTreatmentSubCategory(selectedTreatmentCategory!);
//                                     //                               });
//                                     //                               print('Selected Treatment: ${selectedTreatmentCategory}');
//                                     //                             },
//                                     //                           ),
//                                     //                         ),
//                                     //                       );
...
//                                     //                       items: DoctorTreatmentsSubCategory
//                                     //                           .map((e) => MultiSelectItem(e, e.treatmentSabCategoryData))
//                                     //                           .toList(),
//                                     //                       title: Text('Select Treatments'),
